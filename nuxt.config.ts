  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Crafty+Girls&family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" },
        ...
        { rel: "stylesheet", href: "https://use.typekit.net/aey1hek.css" }
      ],
    }
  },
