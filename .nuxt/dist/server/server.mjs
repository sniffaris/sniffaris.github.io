...
const _routes = [
  {
    name: "aboutMe",
    path: "/aboutMe",
    component: () => import("./_nuxt/aboutMe-Cvh3OoRO.js")
  },
  {
    name: "aboutSniffari",
    path: "/aboutSniffari",
    component: () => import("./_nuxt/aboutSniffari-NO_jF8U8.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-D_NquDVq.js")
  },
  {
    name: "dropinCat",
    path: "/dropinCat",
    component: () => import("./_nuxt/dropinCat-CFoMWS4W.js")
  },
  {
    name: "dropinDog",
    path: "/dropinDog",
    component: () => import("./_nuxt/dropinDog-Dl-wtLG2.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CwY1lBt1.js")
  },
  {
    name: "walks",
    path: "/walks",
    component: () => import("./_nuxt/walks-DoXEISI3.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BnraifZH.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-3y9cuScW.js"));
